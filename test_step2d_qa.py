...
async def run_step2d_qa():
    ...
    desktop_png = os.path.join(base_dir, "verification_step2_complete_desktop.png")
    mobile_png = os.path.join(base_dir, "verification_step2_complete_mobile.png")
    ...
    async with async_playwright() as p:
        ...
        if found_banned:
            ...
            print("Zero banned buzzwords detected in index.html (Clean copy confirmed).")
            
        # Check layout metrics & concentric radius
        metrics = await page.evaluate("""() => {
            ...
            const gradText = document.querySelector('.text-gradient');
            const gradStyle = window.getComputedStyle(gradText);
        ...
        shutil.copy2(desktop_png, os.path.join(artifact_dir, "verification_step2_complete_desktop.png"))
        shutil.copy2(mobile_png, os.path.join(artifact_dir, "verification_step2_complete_mobile.png"))
